...
namespace sarverside
{
    public class _ٌRoom
    {
        ...
        #region properties used outside the class
        ...
        #region check the maxmimum number of players in every room
